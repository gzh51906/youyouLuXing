        ...
        <mytitle v-slot>我的会员中心</Mytitle>       
         ...
         <div class="myorder">
                <van-row type="flex" justify="space-between" class="myorder-top" align='center'>
                    ...
                    <van-col span="6" class="myorder-top-right">
                        全部订单
                        <van-icon name="arrow"/>
                    </van-col>
...
.mystate{
    ...
    padding: 16.5px 26px;
    display: flex;
    background: url('https://www.yoyoer.com/phone/public/images/user-center-home-bg.jpg')  no-repeat;
